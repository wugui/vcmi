...
void registerTypesPregamePacks(Serializer &s)
{
	...
	s.template registerType<CLobbyPackToHost, SetPlayer>();
	s.template registerType<CLobbyPackToHost, SetTurnTime>();
	s.template registerType<CLobbyPackToHost, SetDifficulty>();
